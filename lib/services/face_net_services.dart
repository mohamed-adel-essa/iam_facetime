...
class FaceNetService {
  ...
  static Future<FaceNetService> init() async {
  ...
  String predictNearset() {
    String res = _searchResult(_predictedData ?? []);
  ...
  String _searchResult(List predictedData) {
    try {
      Map<String, dynamic> data = getIt<DataBaseService>().db;
  ...
  double _euclideanDistance(List e1, List e2) {
    if (e2 == null) throw Exception("Null argument");
